...
const Payment = ({
  ...
  const { userAddress, userLatitude, userLongitude, destinationLatitude, destinationAddress, destinationLongitude } = useLocationStore();

  const initializePaymentSheet = async () => {
    const { error } = await initPaymentSheet({
      merchantDisplayName: "JeyTech Ride",
      intentConfiguration: {
        mode: {
