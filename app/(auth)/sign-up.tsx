  ...
  return (
    <ScrollView className="flex-1 bg-white">
      <View className="flex-1 bg-white">
        <View className="relative w-full h-[25Opx]">
        ...
        <ReactNativeModal isVisible={verification.state === 'pending'} onModalHide={() => { (verification.state === 'success') && setShowSuccessModal(true) }}>
